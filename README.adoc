...
:url-job: https://github.com/fabric8-analytics/fabric8-analytics-common/actions/workflows/ci-run-e2e.yml
image:https://github.com/fabric8-analytics/fabric8-analytics-common/actions/workflows/ci-run-e2e.yml/badge.svg[CI Run e2e , link={url-job}]

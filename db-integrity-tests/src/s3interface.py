...
class S3Interface():
    ...
    def connect(self):
        ...
        assert self.s3_configuration.access_key_id is not None
        assert self.s3_configuration.secret_access_key is not None
        assert self.s3_configuration.region_name is not None

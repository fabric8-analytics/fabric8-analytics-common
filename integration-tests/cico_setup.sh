...
F8A_BACKBONE_API_URL=${F8A_BACKBONE_API_URL:-http://f8a-server-backbone-schoudhu-greenfield-test.dev.rdu2c.fabric8.io}
F8A_SERVICE_ID=${F8A_SERVICE_ID:-2555417754383}

 ...
 Scenario: Data validation checks for npm ecosystem
    ...
    Then I should get stack analyses v2 response with all attributes
      ...
      And I should find bootstrap with 4.1.1 5.1.3 4.5.0 with SNYK-JS-BOOTSTRAP-73560 and 6.5 for public vulnerbilities
      ...
      And I should find buefy with 0.7.10 0.9.14 0.8.19 with SNYK-JS-BUEFY-567814 and 7.3 for private vulnerbilities

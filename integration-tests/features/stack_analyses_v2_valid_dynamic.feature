 ...
 Scenario: Data validation checks for npm ecosystem
    ...
    Then I should get stack analyses v2 response with all attributes
      ...
      And I should find bootstrap with 4.1.1 5.0.0 4.5.0 with SNYK-JS-BOOTSTRAP-73560 and 6.5 for public vulnerbilities
 ...
 Scenario: Data validation checks for maven ecosystem
    ...
    Then I should get stack analyses v2 response with all attributes
      ...
      And I should find io.vertx:vertx-core with 3.4.1 4.1.0.Beta1 4.0.0-milestone5 with SNYK-JAVA-IOVERTX-32470 and 5.3 for public vulnerbilities

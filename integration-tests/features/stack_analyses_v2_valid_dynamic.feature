 ...
 Scenario: Data validation checks for npm ecosystem
    ...
    Then I should get stack analyses v2 response with all attributes
      ...
      And I should find buefy with 0.7.10 0.9.3 0.8.19 with SNYK-JS-BUEFY-567814 and 7.3 for private vulnerbilities
 ...
 Scenario: Data validation checks for maven ecosystem
    ...
    Then I should get stack analyses v2 response with all attributes
      ...
      And I should find io.vertx:vertx-core with 3.4.1 4.0.0-milestone5 4.0.0-milestone5 with SNYK-JAVA-IOVERTX-32470 and 5.3 for public vulnerbilities
      ...
      And I should find org.apache.ignite:ignite-core with 2.7.6 2.9.0 2.8.1 with SNYK-JAVA-ORGAPACHEIGNITE-456561 and 4.8 for private vulnerbilities
